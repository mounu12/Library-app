...
class LisofBookDetails extends Component{
    ...
    render(){
        ...
        return(
            <div>
             <div className="col-sm-8 col-sm-offset-2 addnewbook">
            <h6 className="languagesss">English & Indian Languages:
            ...
            <div>{
                ...
                this.props.book.map((bookdetails,index)=>{
                    return(
                      ...
                      <br/>
                      {/* < Link to="/addingbooks"><button type="submit"  className="btn btn-warning" >Add Book</button>
               </ Link> */}
                        </div>
                ...
                < Link to="/addnewbook" className="newbooklink">Add NewBook </Link>
                </div>
...
export default connect(mapStateToProps,{fetchbooks})(LisofBookDetails);